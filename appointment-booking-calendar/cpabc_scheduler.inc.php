...
<form class="cpp_form" name="FormEdit" action="<?php get_site_url(); ?>" method="post"
    ...
    <input type="text" name="name"
           value="<?php /** if (isset($current_user->user_firstname)) echo $current_user->user_firstname." ".$current_user->user_lastname; */ ?>"><br/>
    <?php _e('Your email', 'cpabc'); ?>:<br/>
    <input type="email" name="email"
           value="<?php /** if (isset($current_user->user_email)) echo $current_user->user_email; */ ?>"><br/>
    ...
    <?php if (cpabc_get_option('dexcv_enable_captcha', CPABC_TDEAPP_DEFAULT_dexcv_enable_captcha) != 'false') { ?>
        ...
        <div class="dfield">
            ...
            <div class="error message" id="hdcaptcha_error" generated="true"
                 style="display:none;position: absolute; left: 0px; top: 25px;"></div>
        </div>
        <br/>
    <?php } ?>
