...
jQuery(document).ready(function($){
     ...
     ngykhmnguynvng1.onclick = $("#ngykhmnguynvng1").datepicker({ dateFormat: 'dd.mm.yy',
        onClose: function(){
            document.getElementById("ngykhmnguynvng1").value = $(this).val();
            var input_op1 = document.getElementById("ngykhmnguynvng1").value; 
            var input_op2 = document.getElementById("ngykhmnkoi1").value;
            if(input_op2 != ''){
                  var input_op3 =   input_op1 + "," + input_op2;
            }else{
                  var input_op3 =   input_op1;
            }
            document.getElementById("date_booking1").value = input_op3; 
            
         }
     });

   ngykhmnkoi1.onclick = $("#ngykhmnkoi1").datepicker({dateFormat: 'dd.mm.yy',
        onClose: function(){
            document.getElementById("ngykhmnkoi1").value = $(this).val();
            var input_op1 = document.getElementById("ngykhmnguynvng1").value; 
            var input_op2 = document.getElementById("ngykhmnkoi1").value;
            if(input_op1 != ''){
                  var input_op3 =   input_op1 + "," + input_op2;
