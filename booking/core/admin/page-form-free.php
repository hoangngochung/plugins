            ...
            if (  
                   ...
                   &&  (  ( $form_field['active'] != 'Off' ) || ( $form_field['obligatory'] == 'On' )  )
                    ...
                    if ( $form_field['type'] == 'text' )
                        $my_form.='   <input type="text" name="'. $form_field['name'] . $my_boook_type.'" id="'. $form_field['name'] . $my_boook_type.'" class="col-md-6'
                                        . ( ( $form_field['required'] == 'On' ) ? ' wpdev-validates-as-required' : '' ) 
                                      .'" />';

                    if ( $form_field['type'] == 'email' )
                        $my_form.='   <input type="text" name="'. $form_field['name'] . $my_boook_type.'" id="'. $form_field['name'] . $my_boook_type.'" class="col-md-6 wpdev-validates-as-email'
                                        . ( ( $form_field['required'] == 'On' ) ? ' wpdev-validates-as-required' : '' ) 
                                        . ' wpdev-validates-as-required'        //FixIn: 7.0.1.22
                                      .'" />';

                    if ( $form_field['type'] == 'select' ) {
                        $my_form.='   <select name="'. $form_field['name'] . $my_boook_type.'" id="'. $form_field['name'] . $my_boook_type.'" class="col-md-6'
                                    . ( ( $form_field['required'] == 'On' ) ? ' wpdev-validates-as-required' : '' ) 
                                    . '" />';
